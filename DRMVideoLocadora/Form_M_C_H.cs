...
{
    public class Form_M_C_H : System.Windows.Forms.Form
    {
        ...
        {
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_M_C_H));
            ...
            this.DataGrid1.DataSource = this.DataSet11.Member_Code_Database;
            this.DataGrid1.Enabled = false;
            this.DataGrid1.HeaderForeColor = System.Drawing.SystemColors.ControlText;
            this.DataGrid1.Location = new System.Drawing.Point(8, 8);
            this.DataGrid1.Name = "DataGrid1";
            this.DataGrid1.ReadOnly = true;
            this.DataGrid1.Size = new System.Drawing.Size(384, 208);
            ...
            // OleDbDeleteCommand1
            // 
            this.OleDbDeleteCommand1.CommandText = ("DELETE FROM [Member Code Database] WHERE ([Member ID] = ?) AND ([Member Name] = ?" + " OR ? IS NULL AND [Member Name] IS NULL)");
            ...
            this.OleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Member_Name", System.Data.OleDb.OleDbType.VarWChar, 62, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "Member Name", System.Data.DataRowVersion.Original, null));
            this.OleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Member_Name1", System.Data.OleDb.OleDbType.VarWChar, 62, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "Member Name", System.Data.DataRowVersion.Original, null));
            // 
            // OleDbConnection1
            // 
            ...
            this.OleDbInsertCommand1.CommandText = "INSERT INTO [Member Code Database] ([Member ID], [Member Name]) VALUES (?, ?)";
            ...
            this.OleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Member_Name", System.Data.OleDb.OleDbType.VarWChar, 62, "Member Name"));
            // 
            // OleDbSelectCommand1
            // 
            this.OleDbSelectCommand1.CommandText = "SELECT [Member ID], [Member Name] FROM [Member Code Database]";
            this.OleDbSelectCommand1.Connection = this.OleDbConnection1;
            // 
            // OleDbUpdateCommand1
            // 
            this.OleDbUpdateCommand1.CommandText = ("UPDATE [Member Code Database] SET [Member ID] = ?, [Member Name] = ? WHERE ([Memb" + "er ID] = ?) AND ([Member Name] = ? OR ? IS NULL AND [Member Name] IS NULL)");
            ...
            this.OleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Member_Name", System.Data.OleDb.OleDbType.VarWChar, 62, "Member Name"));
            ...
            this.OleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Member_Name", System.Data.OleDb.OleDbType.VarWChar, 62, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "Member Name", System.Data.DataRowVersion.Original, null));
            this.OleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Member_Name1", System.Data.OleDb.OleDbType.VarWChar, 62, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "Member Name", System.Data.DataRowVersion.Original, null));
            // 
            // Form_M_C_H
            // 
        ...
        // Load data
        private void Form_M_C_H_Load(object sender, System.EventArgs e)
        {
            DataSet11.Clear();
            ...
            // With...
            DataGrid1.Refresh();
            DataGrid1.CaptionText = DataSet11.Tables["Member Code Database"].DefaultView.Count.ToString;
            " Registros";
            // With...
        ...
        private void Button1_Click(object sender, System.EventArgs e)
        {
            ...
            this.BindingContext(DataSet11, "Member Code Database").Position = 0;
        ...
        {
            // TODO: On Error GoTo Warning!!!: The statement is not translatable 
            this.BindingContext(DataSet11, "Member Code Database").Position--;
            DataGrid1.UnSelect(DataGrid1.CurrentRowIndex);
        ...
        {
            // TODO: On Error GoTo Warning!!!: The statement is not translatable 
            this.BindingContext(DataSet11, "Member Code Database").Position = (this.BindingContext(DataSet11, "Member Code Database").Count - 1);
            DataGrid1.UnSelect(DataGrid1.CurrentRowIndex);
            DataGrid1.CurrentRowIndex = (BindingContext(DataSet11, "Member Code Database").Count - 1);
            DataGrid1.Select(DataGrid1.CurrentRowIndex);
            this.Count();
        fix:
            return;
        ...
        private void Button5_Click(object sender, System.EventArgs e)
        {
            // TODO: On Error GoTo Warning!!!: The statement is not translatable 
            int intResponse;
            if ((BindingContext(DataSet11, "Member Code Database").Position < 0))
            {
            ...
            {
                intResponse = MessageBox.Show("Deseja deletar este dado ?", this.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if ((intResponse == System.Windows.Forms.MessageBoxButtons.Yes))
                {
                    OleDbConnection1.Open();
                    if ((this.BindingContext(DataSet11, "Member Code Database").Count > 0))
                    {
                        this.BindingContext(DataSet11, "Member Code Database").RemoveAt(this.BindingContext(DataSet11, "Member Code Database").Position);
                    }
        ...
        private void Count()
        {
            ...
            Records = this.BindingContext(DataSet11, "Member Code Database").Count;
            Current = (this.BindingContext(DataSet11, "Member Code Database").Position + 1);
            if ((this.BindingContext(DataSet11, "Member Code Database").Position > 0))
            {
                enableBack = true;
            }

            if ((BindingContext(DataSet11, "Member Code Database").Position
                        < (DataSet11.Member_Code_Database.Count - 1)))
            {
                enableForward = true;
            }
