...
{
    public class Form_V_Re : System.Windows.Forms.Form
    {
        ...
        {
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_V_Re));
            ...
            this.GroupBox1.Text = "Devolu��es";
            this.Label1.BackColor = System.Drawing.Color.FromArgb(((byte)(255)), ((byte)(224)), ((byte)(192)));
            this.Label1.Location = new System.Drawing.Point(112, 24);
            this.Label1.Name = "Label1";
            this.Label1.Size = new System.Drawing.Size(144, 23);
            this.Label1.TabIndex = 0;
            this.Label1.Text = "Rela��o das devolu��es";
            this.Button5.Location = new System.Drawing.Point(104, 336);
            ...
            this.DataGrid1.DataSource = this.DataSet11.Returnee_Database;
            this.DataGrid1.Enabled = false;
            this.DataGrid1.HeaderForeColor = System.Drawing.SystemColors.ControlText;
            this.DataGrid1.Location = new System.Drawing.Point(8, 8);
            this.DataGrid1.Name = "DataGrid1";
            this.DataGrid1.ReadOnly = true;
            this.DataGrid1.Size = new System.Drawing.Size(352, 216);
            ...
            this.OleDbDataAdapter1.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
                    new System.Data.Common.DataTableMapping("Table", "Returnee Database", new System.Data.Common.DataColumnMapping[] {
                                ...
                                new System.Data.Common.DataColumnMapping("Return Date", "Return Date"),
                                new System.Data.Common.DataColumnMapping("Returned", "Returned")})});
            // 
            // OleDbInsertCommand1
            // 
            this.OleDbInsertCommand1.CommandText = ("INSERT INTO [Returnee Database] ([Member ID], [Return Date], Returned, [Video Cod" + "e]) VALUES (?, ?, ?, ?)");
            ...
            this.OleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Return_Date", System.Data.OleDb.OleDbType.DBDate, 0, "Return Date"));
            this.OleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Returned", System.Data.OleDb.OleDbType.VarWChar, 3, "Returned"));
            ...
            this.OleDbSelectCommand1.CommandText = ("SELECT [Member ID], [Return Date], Returned, [Video Code] FROM [Returnee Database" + "]");
            ...
            this.Name = "Form_V_Re";
            this.Text = "Rela��o das devolu��es";
        ...
        // Load data
        private void Form_V_Re_Load(object sender, System.EventArgs e)
        {
            DataSet11.Clear();
            OleDbDataAdapter1.Fill(DataSet11);
            // With...
            DataGrid1.CaptionText = DataSet11.Tables["Returnee Database"].DefaultView.Count.ToString;
            " Registros";
            this.Count();
            // With...
        ...
        {
            this.BindingContext(DataSet11, "Returnee Database").Position = 0;
        ...
        {
            this.BindingContext(DataSet11, "Returnee Database").Position--;
            DataGrid1.UnSelect(DataGrid1.CurrentRowIndex);
        ...
        {
            this.BindingContext(DataSet11, "Returnee Database").Position = (this.BindingContext(DataSet11, "Returnee Database").Count - 1);
            DataGrid1.UnSelect(DataGrid1.CurrentRowIndex);
            DataGrid1.CurrentRowIndex = (BindingContext(DataSet11, "Returnee Database").Count - 1);
            DataGrid1.Select(DataGrid1.CurrentRowIndex);
            this.Count();
        }
        ...
        private void Count()
        {
            ...
            Records = this.BindingContext(DataSet11, "Returnee Database").Count;
            Current = (this.BindingContext(DataSet11, "Returnee Database").Position + 1);
            if ((this.BindingContext(DataSet11, "Returnee Database").Position > 0))
            {
                enableBack = true;
            }

            if ((BindingContext(DataSet11, "Returnee Database").Position
                        < (DataSet11.Returnee_Database.Count - 1)))
            {
                enableForward = true;
            }
